...
namespace BrewLib.Graphics.Text
{
    public class TextFontAtlased : TextFont
    {
        ...
        private FontGlyph generateGlyph(char c)
        {
            ...
            {
                DrawState.TextGenerator.CreateBitmap(c.ToString(), name, size, Vector2.Zero, out measuredSize, true);
            ...
            else
            {
                ...
                using (var bitmap = DrawState.TextGenerator.CreateBitmap(c.ToString(), name, size, Vector2.Zero, out measuredSize, false))
                {
